...
import os
from implementation.db import get_report_by_planner_id, listing_all_journey
import json
...
def answer_question(question: str, history: list[dict] = [],role:str=""):
    if(role=="product"):
        DB_NAME = "/Users/yashsinghal/Documents/trinity_assistant/testing_ui/product_vector_db"
        vectorstore = Chroma(persist_directory=DB_NAME, embedding_function=embeddings)
        retriever = vectorstore.as_retriever()
